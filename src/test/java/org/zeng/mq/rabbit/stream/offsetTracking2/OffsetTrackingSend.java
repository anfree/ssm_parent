 ...
 * a producer that sends a wave of messages with a marker message at the end, and a consumer that receives messages and stops when it gets the marker message.
 * P -> Stream Queue <---> C
 *
 * @author 曾祥江
 * @since 2025/1/23
